...
public abstract class TopPushMessageReceiver extends BroadcastReceiver {
     ...
     * 收到透传消息
     */
    public static final String RECEIVE_THROUGH_MESSAGE = "com.toppush.RECEIVE_THROUGH_MESSAGE";
    /**
     * 通知栏消息到达
     */
    public static final String NOTIFICATION_ARRIVED = "com.toppush.NOTIFICATION_ARRIVED";
    /**
     * 通知栏消息被点击
     */
    public static final String NOTIFICATION_CLICKED = "com.toppush.NOTIFICATION_CLICKED";
    /**
     * 出现异常
     */
    public static final String ERROR = "com.toppush.ERROR";
    ...
    public final void onReceive(Context context, Intent intent) {
        if (intent != null) {
            ...
            try {
                TopPushMessage message = (TopPushMessage) intent.getSerializableExtra(MESSAGE);
     ...
     * 透传
     */
    public abstract void onReceivePassThroughMessage(Context context, TopPushMessage message);

    /**
     * 通知栏消息点击
     */
    public abstract void onNotificationMessageClicked(Context context, TopPushMessage message);
